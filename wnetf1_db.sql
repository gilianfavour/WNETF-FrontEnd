...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 19, 2026 at 08:27 AM
...
INSERT INTO `applications_application` (`id`, `full_name`, `dob`, `email`, `phone`, `course`, `university`, `university_reg_number`, `university_email`, `student_number`, `grades`, `district`, `other_district`, `guardian_name`, `address`, `personal_statement`, `attachment`, `status`, `created_at`, `updated_at`) VALUES
(1, 'Favour Gilian', '2004-06-05', 'gilianfavour06@gmail.com', '0780488850', 'Bachelors In Computer Science', 'Makerere University', '2027/MBCS/001122', 'gilianfavour06@gmail.com', '2233777', 'Straight A\'s', 'Arua', '', 'Adia Christopher', 'Ociba', 'Love for more of tech', 'applications/documents/FAVOUR_GILIAN_CV_.pdf', 'approved', '2026-03-27 09:28:03.310141', '2026-03-27 09:29:56.723585');
...
(69, 'Can add team member', 18, 'add_teammember'),
(70, 'Can change team member', 18, 'change_teammember'),
(71, 'Can delete team member', 18, 'delete_teammember'),
(72, 'Can view team member', 18, 'view_teammember');
...
(1, 'pbkdf2_sha256$600000$wzesL08MHhO2jquSkhjG1h$ZMLUe11q+/aVl4uSu1WeDO1r+bvczKHhZtX58sXTdBU=', '2026-03-30 10:54:49.373991', 1, 'superadmin', '', '', 'superadmin@wnetf.org', 1, 1, '2026-03-26 21:01:15.348475'),
(2, 'pbkdf2_sha256$600000$T8KSCUdr1bKwgtGISKkDq4$Nc9A+tCuga1npvyD+58fe0pYP50dQ8hq9WghXUIz3hI=', '2026-06-18 19:08:21.272863', 1, 'superadmin1', '', '', 'superadmin1@wnetf.org', 1, 1, '2026-06-18 16:35:43.737716');
...
(8, 'Scholarship', 'scholarship', 'A strong scholarship motivation letter (400–700 words) must highlight your unique journey, aligning personal goals with the scholarship\'s mission. It should showcase your academic achievements, professional passion, and future plans, explaining why you deserve the award and how you will make a positive impact', 'Dear Members of the Scholarship Committee,\nIntroduction\nMy name is [Your Name], and I am writing to express my strong interest in the [Name of Scholarship] to support my Master’s degree in Renewable Energy at [University Name]. As a passionate advocate for sustainable development, my goal is to implement affordable green energy solutions in my home country to combat the rising energy crisis. \nGradRight\nGradRight\n +1\nAcademic & Professional Background\nDuring my undergraduate studies in Mechanical Engineering, I focused my research on solar thermal technology. My thesis, titled \"Modeling of Solar Adsorption Cooling,\" allowed me to develop technical skills in energy efficiency that increased theoretical output by 15%. Beyond the classroom, I interned at [Company Name], where I assisted in designing water supply mechanisms for rural towns, teaching me the value of practical, community-focused engineering. \nScribd\nScribd\n +3\nWhy This Scholarship and Program?\nI have chosen [University Name] because of its world-class research in Bio-Energy Systems, which is a critical area for remote regions in my country. However, coming from a middle-income family, the £40,000 program fee is currently beyond my reach. This scholarship would remove the financial burden, allowing me to dedicate myself fully to my studies and participate in the program\'s mandatory international exchange to gain global perspectives on energy systems. \nScribd\nScribd\n +2\nFuture Impact\nUpon completion of my degree, I plan to return home to establish a sustainable water and energy consultancy. By 2030, I aim to implement solutions that provide clean power to at least 50 drought-affected villages. I am confident that my academic background and dedication make me a strong candidate who will provide a high \"return on investment\" for your organization. \nGradRight\nGradRight\n +1\nThank you for your time and for considering my application. \nIDP Education\nIDP Education\n +1\nSincerely,\n[Your Name]', 'Favour Gilian', '', 'Motivation', 1, '2026-03-30 09:10:13.433170', '2026-03-30 09:10:13.433232');
...
INSERT INTO `contact_contactmessage` (`id`, `name`, `email`, `phone`, `subject`, `message`, `is_read`, `created_at`) VALUES
(1, 'Favour Gilian', 'gilianfavour06@gmail.com', '', 'value0', 'How do i qualify', 0, '2026-03-27 09:45:47.967168'),
(2, 'Favour Gilian', 'gilianfavour06@gmail.com', '', 'value0', 'How do i qualify', 0, '2026-03-27 09:47:28.371265');
...
(17, 'management', 'partner'),
(18, 'management', 'teammember'),
(6, 'sessions', 'session'),
...
(28, 'events', '0002_event_is_active', '2026-03-26 19:42:03.077740'),
(29, 'management', '0001_initial', '2026-03-26 19:42:03.426924'),
(30, 'management', '0002_partner_password_teammember_password', '2026-03-26 19:42:03.549660');
...
('0v6fwa04nsr5g5feqirm46pb1vwmqqxv', '.eJxVjEsOAiEQBe_C2hCYRqBdup8zEBpoGTWQzGdlvLtOMgvdvqp6LxHittawLWUOUxYXMYjT70YxPUrbQb7Hdusy9bbOE8ldkQdd5NhzeV4P9--gxqV-aweGHaFirQCBB6Uoa3P2JiYEi2yAAR05HpCzzVZ5MujBWquBdNLi_QG9nDbG:1waFjA:FVew-K8sSBZm9Z7-ysaIAKHZNlDT7ApzJ96Ja7sZIhc', '2026-07-02 16:36:28.837134'),
('8p26j2t53jwcu2vb3pboq1g7lvzplsrv', '.eJxVjEsOAiEQBe_C2hCYRqBdup8zEBpoGTWQzGdlvLtOMgvdvqp6LxHittawLWUOUxYXMYjT70YxPUrbQb7Hdusy9bbOE8ldkQdd5NhzeV4P9--gxqV-aweGHaFirQCBB6Uoa3P2JiYEi2yAAR05HpCzzVZ5MujBWquBdNLi_QG9nDbG:1waI69:bmisCKPl0OtpVRQhow5_vLn_a638vjoF8LOiAIYWWqg', '2026-07-02 19:08:21.293263'),
('he2phm4t5snpge2fjktjdilzjxthtgkl', '.eJxVjE0OwiAYBe_C2hCQUsSl-56BwPcjVQNJaVfGu0uTLnT7Zua9RYjbmsPWaAkziqvQ4vS7pQhPKjvARyz3KqGWdZmT3BV50CanivS6He7fQY4t99przaQhjYNlsqqHzKMCRxZVAnUhhYxWUUzJ8wCOtbNgzqYT8Gic-HwBFk45GQ:1w7AGf:DSzDN7-eKaUHI-vxzNfcOS4vw74_4TIrHGMfDDaUdvM', '2026-04-13 10:54:49.630955');
...
--
-- Dumping data for table `donate_donation`
--

INSERT INTO `donate_donation` (`id`, `name`, `email`, `phone`, `amount`, `currency`, `frequency`, `message`, `is_anonymous`, `created_at`) VALUES
(1, 'Anonymous', 'anonymous@wnetf.org', '', 100000.00, 'UGX', 'once', '', 1, '2026-03-27 09:38:24.464423');
...
INSERT INTO `events_event` (`id`, `title`, `description`, `date`, `location`, `image`, `is_upcoming`, `registration_link`, `created_at`, `is_active`) VALUES
(1, 'West Nile Night � Monthly Fundraiser', 'Join us every last Friday of the month for the West Nile Night fundraising dinner. An evening of community, culture, and giving.', '2026-03-20 18:19:23.914901', 'Kampala, Uganda', '', 1, '', '2026-03-06 18:19:23.919153', 1),
(2, 'WNETF Annual Dinner 2024', 'Our flagship annual fundraising dinner bringing together donors, scholars, graduates and community leaders to celebrate impact and raise funds for the next cohort.', '2026-06-04 18:19:23.914914', 'Kampala Serena Hotel', '', 1, '', '2026-03-06 18:19:23.926212', 1),
(3, 'Scholar Orientation Day 2024', 'Annual orientation for newly admitted WNETF scholars. Meet your mentors, fellow scholars, and the WNETF board.', '2026-02-04 18:19:23.914917', 'Arua, West Nile', '', 0, '', '2026-03-06 18:19:23.942830', 1),
(4, 'West Nile Night — Monthly Fundraiser Dinner', 'Join us every last Friday of the month for the West Nile Night fundraising dinner. An evening of West Nile culture, music, food, and community generosity. All proceeds go directly to student scholarships. Tables available for groups and individuals.', '2026-03-20 18:30:05.988768', 'Nexus Lounge, Kampala', '', 1, 'mailto:inquirieswnetf@gmail.com', '2026-03-06 18:30:05.996323', 1),
(5, 'WNETF Annual Gala Dinner 2025', 'Our flagship annual fundraising gala brings together donors, scholars, graduates, board members and community leaders to celebrate impact and raise funds for the incoming cohort of scholars. Black-tie event with live entertainment, keynote speakers and a silent auction.', '2026-06-04 18:30:05.988768', 'Kampala Serena Hotel, Kampala', '', 1, 'mailto:inquirieswnetf@gmail.com', '2026-03-06 18:30:06.007067', 1),
(6, 'Scholar Meet & Greet — New Cohort 2025', 'Newly selected WNETF scholars for 2025 will meet their mentors, board representatives and fellow scholars for the first time. An orientation on academic expectations, code of conduct and support systems available through WNETF.', '2026-04-10 18:30:05.988768', 'Arua City, West Nile', '', 1, '', '2026-03-06 18:30:06.019928', 1),
(7, 'WNETF Fun Run — Arua 2024', 'Our inaugural community fun run held in Arua City raised over UGX 12,000,000 for the scholarship fund. Hundreds of participants from the West Nile community, diaspora visitors, and scholars turned out to run, walk, and celebrate education.', '2025-12-16 18:30:05.988768', 'Arua City Stadium, West Nile', '', 0, '', '2026-03-06 18:30:06.026460', 1),
...
--
-- Table structure for table `management_partner`
--

CREATE TABLE `management_partner` (
  `id` bigint(20) NOT NULL,
  `name` varchar(200) NOT NULL,
...
--
-- Dumping data for table `management_partner`
--

INSERT INTO `management_partner` (`id`, `name`, `partnership_type`, `website_url`, `logo`, `is_active`, `description`, `created_at`, `password`) VALUES
(1, 'Crown Beverages', 'sponsor', 'https://pepsi-cola.co.ug/', 'partners/crwon_bevearges.png', 1, '', '2026-03-28 06:55:59.778150', 'partner123'),
(2, 'Muni University', 'sponsor', 'http://muni.ac.ug/', 'partners/muni_uni.png', 1, '', '2026-03-28 07:04:15.847393', 'partner123');

-- --------------------------------------------------------

--
-- Table structure for table `management_teammember`
--

CREATE TABLE `management_teammember` (
  `id` bigint(20) NOT NULL,
  `full_name` varchar(200) NOT NULL,
...
--
-- Dumping data for table `management_teammember`
--

INSERT INTO `management_teammember` (`id`, `full_name`, `role`, `email`, `bio`, `photo`, `is_active`, `order`, `created_at`, `password`) VALUES
(1, 'Robinah', 'Program Lead', 'robi.andama@gmail.com', '', 'team/myprofphoto.png', 1, 0, '2026-03-27 08:06:40.681580', 'admin123');
...
--
-- Dumping data for table `subscribe_subscriber`
--

INSERT INTO `subscribe_subscriber` (`id`, `email`, `name`, `is_active`, `created_at`) VALUES
(1, 'gilianfavour06@gmail.com', '', 1, '2026-03-27 09:46:54.636985');
...
--
-- Indexes for table `management_partner`
--
ALTER TABLE `management_partner`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `management_teammember`
--
...
--
-- AUTO_INCREMENT for table `management_partner`
--
ALTER TABLE `management_partner`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `management_teammember`
--
ALTER TABLE `management_teammember`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
